...
bool PlanningComponent::Init() {
  ...
  //FLAGS_planning_offline_learning为false
...
bool PlanningComponent::Proc(
  ...
  // process fused input data 将所有外部输入封装到local_view下
  ...
  //adc_trajectory_pb 存储路径规划出的路径信息
